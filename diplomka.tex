...
Agile, Communication, Company, Interruption, Organization, Team, Teamwork.
\end{ThesisKeyWords}
\MainMatter
...
Management of internal organizational communication is very often neglected. Reasons for this vary, but the most common is, that the communication will manage itself according to a common sense. This results in companies suffering from insufficient or excessive, not efficient or even not effective communication, which leads to several serious problems. 

As an employee of Y Soft Corporation, I can tell, that internal communication is certainly not being neglected.  by defining and opening communication paths throughout the organizational structure. There are several internal policies for assuring efficient meetings, reporting of incidents and defining tasks.



The first chapter of this thesis explains,   with a focus on software engineers.
