...
(agile manifesto)
In recent years, word Agile became very popular, mostly among managers in software companies. Agile 

The Agile Manifesto is driven by the following principles, as stated in \cite{agileManifesto}:
\begin{itemize}
...
\end{itemize}
The principles show, that continuous cooperation is essential. 
...
After a few weeks of my presence in the team I started noticing, that the developers of the team go home frustrated quite regurarly. Often they leave work earlier. Their reason is that they did nothing that day and there is no point in staying there longer. On the other hand, some other days I see them working late hours, most of the time apparently stressed out about not meeting deadlines.
...
I strongly believe, that the AnyOffice tool, together with the idea it carries, will be a success and will make it easier for software companies to better manage their internal communication in their agile environments.
