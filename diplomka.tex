...
In order to understand the employees, their customs and needs, first we have to look at the company itself, with focus on Research and Development department. The following section is based on information form Y Soft's website \cite{ysoft} and ............
...
Sending IMs with request for consultation - overseen
Historical attempts (headphones, hats) )
		
		\subsection{Consultations from CSS}
(HT302

konzultácie cez team leaderov

každá komponenta má namapovaný team a teda aj team leadera, ktorý konzultáciu prehodí na team membera a ten písomne odpovedá

takto idú veci od zákazníka ale aj interné veci (defekty, workaroundy)

ak je písomná odpoveď nedostatočná, tak sa pokračuje v písaní si alebo sa volá team leaderovi

neoficiálne sa stáva, že sa telefonuje alebo posiela IM priamo developerovi alebo sa ide po face-to-face ad-hoc konzultáciu

ak CSS má remote desktop k zákazníkovi, tak je potrebná aktívna ad-hoc asistencia od RnD

pre CSS je potreba u platinového zákazníka mať okamžitú podporu od RnD (riešenie problému do 1 h))
...
The same as in Y Soft, members of Research and Development department in Kentico are also divided into teams. However, each team in Kentico is self-sustaining and cooperation among teams is exceptional. The cause of this difference is high degree of decoupling of modules, or better said, parts of their product portfolio.
