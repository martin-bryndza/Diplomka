...
This chapter will elaborate on possible solutions of the defines issues and present the selected one.

\paragraph*{Use existing IMs: } As stated in section \ref{commImportance}, face-to-face communication is important because of its high efficiency and it would be counterproductive to eliminate it. Moreover, co-workers should be encouraged to choose this form of communication over communication using email or IMs, which are very popular. Even though forcing the communication to happen over IMs would solve 



Redirecting all communication through team leader would disable him totally, moreover he/she is usually unreachable.

As mentioned in section \ref{rndMeetings}, there have already been some attempts for the people to become unavailable. None of them really worked and soon people started to ignore them. But why? Because, as reasoned before, ad-hoc face-to-face communication is crucial. Most people think that their matter is of high importance and need the answer as soon as possible. With the former methods, unavailable state of a person could last hours or even until going home. Moreover, the potential initiator of the conversation had no possibility to know, when the person became available and could easily miss than period of one's availability. To sum things up, the default state was the unavailable state, which is unacceptable in an agile cooperative environment.
